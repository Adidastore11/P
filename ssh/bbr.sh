...
Check_And_Add_Line "/etc/security/limits.conf" "* soft nofile 262144"
Check_And_Add_Line "/etc/security/limits.conf" "* hard nofile 262144"
Check_And_Add_Line "/etc/security/limits.conf" "root soft nofile 262144"
Check_And_Add_Line "/etc/security/limits.conf" "root hard nofile 262144"
Check_And_Add_Line "/etc/sysctl.conf" "fs.file-max = 262144"
